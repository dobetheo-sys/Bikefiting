...
import { toPoseFrame, type MPPoseLandmarkerResult } from './pose-integration';
...
describe('toPoseFrame — conversion PoseLandmarkerResult -> PoseFrame', () => {
  ...
  test('retourne null si aucune pose détectée', () => {
